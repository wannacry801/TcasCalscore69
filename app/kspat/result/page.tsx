...
export default function KspatResultPage() {
  ...
  if (hisRow) {
    ...
    compareUI = (
      <div className="rounded-[22px] bg-[#EAF4F0] border border-[#CFE5DC] px-5 py-6 space-y-3">
        <h2 className="text-lg font-semibold text-[#2F7D6B]">
          วิเคราะห์โอกาสติด
        </h2>
    ...
    <div className="min-h-screen flex justify-center bg-[#F2F8F5] py-12 px-4">
      <div className="w-full max-w-xl rounded-[28px] bg-white border border-[#DDEBE4] px-6 py-10 space-y-8">
        ...
        <Button
          ...
          radius="full"
          size="lg"
          className="mx-auto block px-12 py-6 bg-[#A7D7C5] text-[#2F7D6B]
                     text-xl font-semibold shadow-md hover:opacity-90"
        >
          กลับหน้าหลัก
        </Button>
