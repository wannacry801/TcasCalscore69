...
return (
  ...
  This project is licensed under CC BY-NC-ND 4.0.<br/>
  ห้ามนำโค้ดส่วนใดไปใช้งานเชิงพาณิชย์ คัดลอก หรือดัดแปลงโดยไม่ได้รับอนุญาต<br/><br/>
  เว็บไซต์นี้จัดทำขึ้นเพื่อช่วยคำนวณคะแนนเบื้องต้นเท่านั้น ผลลัพธ์ไม่สามารถรับประกันผลจริงได้
</div>
      </div>
    </div>
  );
